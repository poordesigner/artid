...
Route::get('/coa/{certificateNumber}/verify', [CertificateController::class, 'verify'])->name('certificates.verify');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/artworks/{artwork}/validate-qr', [ArtworkController::class, 'validateQr'])->name('artworks.validate-qr');
    ...
    Route::post('/artworks/{artwork}/certificates', [CertificateController::class, 'store'])->name('certificates.store');
    Route::get('/artworks/{artwork}/certificates/preview', [CertificateController::class, 'preview'])->name('certificates.preview');
    Route::patch('/artworks/{artwork}/certificates/{certificate}', [CertificateController::class, 'update'])->name('certificates.update');
    Route::get('/artworks/{artwork}/certificates/{certificate}/download', [CertificateController::class, 'download'])->name('certificates.download');
    Route::post('/artworks/{artwork}/certificates/{certificate}/revoke', [CertificateController::class, 'revoke'])->name('certificates.revoke');
});
