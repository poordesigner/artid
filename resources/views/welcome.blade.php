                ...
                <div class="p-8 sm:p-10 flex flex-col justify-center">
                    ...
                    <div class="mt-10 space-y-10">
                        <div>
                            ...
                            <h3 class="mt-3 text-lg font-semibold tracking-wide text-gray-900">{{ __('Ficha de Datos Digital') }}</h3>
                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{{ __('Crea una ficha técnica básica de tu obra: título, año, edición, serie, técnicas, dimensiones, descripción, imagen y links externos.') }}</p>
                        </div>
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{{ __('Cada obra se asocia con un QR único que nunca cambia y es el medio de acceso fácil a la ficha técnica de la misma. Lo puedes usar como quieras: imprimir, pegar a tu obra, incluir en páginas web o donde lo consideres conveniente.') }}</p>
                        </div>
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{{ __('La relación entre la ficha técnica y la ruta de acceso del código QR está firmada criptográficamente. Solo la obra auténtica accede a su ficha.') }}</p>
                        </div>
                        <div>
                            <p class="text-4xl font-light text-gray-200">04</p>
                            <h3 class="mt-3 text-lg font-semibold tracking-wide text-gray-900">{{ __('Historial de Exposiciones') }}</h3>
                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{{ __('Documenta el historial de exposiciones asociadas a tu obra. Registrando el lugar, las fechas y links externos de cada exposición.') }}</p>
                        </div>
                        <div>
                            <p class="text-4xl font-light text-gray-200">05</p>
                            <h3 class="mt-3 text-lg font-semibold tracking-wide text-gray-900">{{ __('Procedencia (Historial de Propiedad) y Certificado de Autenticidad (COA)') }}</h3>
                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{{ __('Si la obra deja de ser de la tenencia del artista y pasa a un nuevo propietario, se puede crear un nuevo registro de procedencia (con los datos básicos o anónimos del nuevo propietario) y generar un Certificado de Autenticidad (COA) con un ID criptográfico especial. El nuevo propietario, al acceder a la ficha técnica de la obra con el código QR, podrá validar la legalidad de la misma usando el ID criptográfico asociado a su COA y tener una herramienta adicional para demostrar su derecho de tenencia de la obra.') }}</p>
                        </div>
                    </div>
                </div>
