...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .verified { display: inline-flex; align-items: center; gap: 6px; margin-top: 12px; font-size: 0.8rem; color: #22c55e; border: 1px solid #1f3a2a; background: #0f1f14; border-radius: 9999px; padding: 4px 12px; }
        ...
        .event { padding: 14px 0; border-bottom: 1px solid #1a1a1a; }
