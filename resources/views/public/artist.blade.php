...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .avatar { width: 96px; height: 96px; border-radius: 50%; object-fit: cover; border: 2px solid #333; background: #111; }
        .name { font-size: 1.8rem; font-weight: 600; margin-top: 16px; line-height: 1.2; }
        .verified { display: inline-flex; align-items: center; gap: 6px; margin-top: 8px; font-size: 0.8rem; color: #22c55e; border: 1px solid #1f3a2a; background: #0f1f14; border-radius: 9999px; padding: 4px 12px; }
        .section { margin-top: 32px; }
        .section h2 { font-size: 0.85rem; color: #ff0066; text-transform: uppercase; letter-spacing: 0.12em; border-bottom: 1px solid #222; padding-bottom: 8px; }
        ...
        .links a { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border: 1px solid #333; border-radius: 9999px; color: #f5f5f5; text-decoration: none; font-size: 0.85rem; transition: border-color 0.2s, color 0.2s; }
        .links a:hover { border-color: #ff0066; color: #ff0066; }
        .links a svg { width: 16px; height: 16px; fill: currentColor; }
        .cv-link { display: inline-flex; align-items: center; gap: 6px; margin-top: 12px; padding: 8px 16px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #f5f5f5; text-decoration: none; font-size: 0.85rem; transition: border-color 0.2s; }
