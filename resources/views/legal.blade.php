            ...
            <div x-show="tab === 'datos'" x-cloak class="mt-6 bg-white shadow-sm sm:rounded-lg p-6 sm:p-8">
                ...
                <div class="mt-6 prose prose-sm max-w-none text-gray-700 space-y-6">
                    ...
                    <section>
                        ...
                        <p class="mt-1">QRTE / POORdesigner.com<br>https://qrte.poordesigner.com<br>https://qrte.poordesigner.com<br><a href="mailto:qrte@poordesigner.com" class="text-brand hover:underline">qrte@poordesigner.com</a></p>
                    </section>
                </div>
            </div>
                ...
                <div class="mt-6 prose prose-sm max-w-none text-gray-700 space-y-6">
                    ...
                    <section>
                        ...
                        <div class="mt-2 space-y-2">
                            <p><strong>4.1</strong> {{ __('Recibes QRTE_WELCOME_TOKENS (hoy 5) al primer registro, una sola vez.') }}</p>
                    ...
                    <section>
                        ...
                        <p class="mt-1"><a href="mailto:qrte@poordesigner.com" class="text-brand hover:underline">qrte@poordesigner.com</a> — POORdesigner.com / QRTE, https://qrte.poordesigner.com</p>
                    </section>
                </div>
            </div>
