...
#[Fillable(['name', 'email', 'password', 'google_id', 'github_id', 'github_token', 'github_nickname', 'github_repo', 'short_domain', 'avatar', 'signature_image', 'statement', 'cv_pdf', 'website_url', 'instagram', 'behance', 'artstation', 'youtube', 'tiktok', 'is_admin', 'granted_plan_id', 'granted_expires_at', 'tokens_balance', 'welcome_tokens_claimed', 'last_login_at', 'terms_accepted_at', 'terms_version', 'terms_ip', 'terms_user_agent', 'marketing_consent', 'marketing_consent_at', 'marketing_ip'])]
...
class Artist extends Authenticatable
{
    ...
    public function signatureUrl(): ?string
    {
        ...
        return rtrim((string) config('filesystems.disks.r2.url'), '/').'/artists/'.$this->id.'/'.$this->signature_image;
    }
    ...
    public function grantWelcomeTokens(): bool
    {
        ...
        $amount = (int) config('qrte.welcome_tokens', 0);
